...
RES:  00 [9000]
        ...
        /// <param name="Kmac"></param>
        /// <returns></returns>
        public int SaveIDL2Card6(byte[] DG1, byte[] DG2, byte[] DG3, byte[] DG4, byte[] DG5, byte[] DGCommon, byte[] Kenc, byte[] Kmac)
        {
            log.Info("SaveIDL2Card");
        ...
        /// <param name="Kmac"></param>
        /// <returns></returns>
        public int SaveVL2Card3(byte[] DG1, byte[] Kenc, byte[] Kmac)
        {
            log.Info("SaveIDL2Card");
