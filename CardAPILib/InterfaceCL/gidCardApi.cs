        ...
        public int SaveIDL2Card3(byte[] DG1, byte[] DG2, byte[] DG3, byte[] DG4, byte[] DG5, byte[] DGCommon, byte[] Kenc, byte[] Kmac)
        {
            ...
            try
            {
                ...
                */
                 ...
                 */
                //ISO7816.CreateFile
                if (CallApduCommand(0x00, 0xE0, 0x00, 0x00, new byte[23] { 0x62, 0x15, 0x80, 0x02, 0x00, 0x27, 0x82, 0x01, 0x01, 0x83, 0x02, 0x00, 0x03, 0x86, 0x02, 0x5C, 0x0C, 0x88, 0x01, 0x18, 0x8A, 0x01, 0x05 }) != 0)
                {
                    return -11;
                }
