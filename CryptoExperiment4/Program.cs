...
namespace CryptoExperiment4
{
    class Program 
    {
        ...
        static void Main(string[] args)
        {
            ...
            //var bb = new byte[] {  };

            //var vll = vl.ParseReadMaterial(bb);

            RunBurun();

            //var ffff = Int2ByteArray(296);
        ...
        static  void RunBurun()
        {
            ...
            var res = DXX_CardApi.CardApi.WriteDXXInfo(LoadJsonIDL()).Result;
        ...
        public static string LoadJsonIDL()
        {
            ...
            using (StreamReader r = new StreamReader(@"C:\RADSOFT\LOG\DXX.json", Encoding.UTF8))
            {
                json = r.ReadToEnd();
        ...
        {
            var uuid = await DXX_CardApi.CardApi.ReadUUidAsync();
