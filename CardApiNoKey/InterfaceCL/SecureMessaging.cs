...
namespace CardAPILib.InterfaceCL
{
    ...
    public class SecureMessaging
    {
        ...
        public int InstallAppletV5()
        {
            ...
            {
                log.Info("80 E6 0C 00 [24] 08 D2 76 00 00 98 45 41 43 07 A0 00 00 02 47 10 01 07 A0 00 00 02 48 05 00 01 08 07 C9 05 4C 00 FD 42 42 00");

                #region 80 E6 0C 00 [24] 08 D2 76 00 00 98 45 41 43 07 A0 00 00 02 47 10 01 07 A0 00 00 02 48 05 00 01 08 07 C9 05 4C 00 FD 42 42 00

                APDUCommand apduSize5 = new APDUCommand(0x80, 0xE6, 0x0C, 0x00, null, 0);

                APDUParam apduParam5 = new APDUParam();

                apduParam5.Data = new byte[36] { 0x08, 0xD2, 0x76, 0x00, 0x00, 0x98, 0x45, 0x41, 0x43, 0x07, 0xA0, 0x00, 0x00, 0x02, 0x47, 0x10, 0x01, 0x07, 0xA0, 0x00, 0x00, 0x02, 0x48, 0x05, 0x00, 0x01, 0x08, 0x07, 0xC9, 0x05, 0x4C, 0x00, 0xFD, 0x42, 0x42, 0x00 };
