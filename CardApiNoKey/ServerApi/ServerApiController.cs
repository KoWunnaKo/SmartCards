...
namespace GID_Client.ServerApi
{
    ...
    public class ServerApiController
    {
        ...
        //    var _url = string.Format(GlobalSolutions.Properties.Settings.Default.GetCertificate, CardNumber);
        ...
        public static getResponceCardInsert GetKey(string CardNumber)
        {
            ...
            string apiString = appConfig.AppSettings.Settings["GetKeyApi"].Value;
        ...
        //{
        //    var _url = GlobalSolutions.Properties.Settings.Default.RegisterCardAPI;
        ...
        public static LoginResponce LoginReqRes(string login, string password)
        {
            ...
            var appConfig = ConfigurationManager.OpenExeConfiguration(Assembly.GetExecutingAssembly().Location);
            string _url = appConfig.AppSettings.Settings["LoginApi"].Value;
            //var _url = ConfigurationManager.AppSettings["LoginApi"]; 
        ...
        //    if (isDL)
        //    {
        //        _url = GlobalSolutions.Properties.Settings.Default.ActivationDLApi;  
        //    }
        //    else
        //    {
        //        _url = GlobalSolutions.Properties.Settings.Default.ActivationVRApi;
        //    }
