...
namespace TsexTestApp1
{
    class Program
    {
        private static CardNative _card;
        ...
        private static void _card_OnCardRemoved(string reader)
        {

        }

        private static void _card_OnCardInserted(string reader)
        {
        ...
        public static void ReadCardApplet(object reader)
        {
        ...
        public static void OpenTsex(object reader)
        {
            string m_reader = (string)reader;
        ...
        /// <returns></returns>
        private static int CallApduCommandLe(byte Cla, byte Ins, byte P1, byte P2, byte[] data, uint _recieveLength, string readerInfo , CardNative _cardx)
        {
        ...
        /// <param name="readerInfo"></param>
        /// <returns></returns>
        private static int CallApduCommandLe(byte Cla, byte Ins, byte P1, byte P2, byte Le, uint _recieveLengt,string readerInfo, CardNative _cardx)
        {
            APDUResponse apduResp;
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        private static int CallApduCommand(byte Cla, byte Ins, byte P1, byte P2, byte[] data, string readerInfo, CardNative _cardx)
        {
            APDUResponse apduResp;
        ...
        /// <returns></returns>
        private static int TsexCommands(object reader, CardNative _cardx)
        {
        ...
        private static byte[] CallApduCommandLeData(byte Cla, byte Ins, byte P1, byte P2, byte[] data, uint _recieveLength, CardNative _cardx, string readerInfo)
        {
