...
{
    internal class DXXViewModel : ViewModelBase
    {
        ...
        private int PfReadCard()
        {
                ...
                try
                {
                    ...
                    try
                    {
                       ...
                       DXX_DataTransformer DrL = new DXX_DataTransformer("");

                        var dl = DrL.ParseReadDXX(DG1, DG2, DG3, DG4, DG5, DGCommon);

                        LastName = dl._last_name;

                        FirstName = dl._first_name;

                        MiddleName = dl._middle_name;

                        BirthDate = dl._position;
                        ...
                        LicenseNumber = dl._badge_number;

                        PNFL = dl._pinfl;

                        BirthPlace = dl._rank;

                        Base64ImageData = dl._Photo;

                        Base64ImageData2 = dl._Signature;
        ...
        private async void fReadCard()
        {
            ...
            InputString = encKey.Substring(0, 16);
